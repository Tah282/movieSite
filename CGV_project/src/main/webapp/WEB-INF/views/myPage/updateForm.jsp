...
<body>
	...
	<div class="center">
		<br><h1>게시글 수정 페이지</h1><br>
		
		<form class="formData" method="post" action="${contextPath}/myPage/boardUpdatePro.do" onsubmit="return false">
			<table class="updateTable" border="1">
				...
				<tr> <td>작성자&nbsp&nbsp</td> <td>${board.writer}</td> </tr>
