...
public class ManagerController {
	...
	public String boardReWriteForm(HttpSession session, HttpServletRequest request, Model model) {
		
		String id = (String)session.getAttribute("log");
		
		String name = mapper.getOneManager(id);
		model.addAttribute("managerName", name);
